h1. Datenschutzerklärung Digitalisierte Drucke – Stand 24.05.2018
...
ist Art. 6 Abs. 1 lit. e und f DSGVO.
...
h3. 6.1 Beschreibung und Umfang der Datenverarbeitung

*39* Es ist eine Kontaktaufnahme über die unter den Reitern "Ansprechpersonen"
und "Impressum" verlinkten E-Mail-Adressen möglich. Bei Klick auf die E-Mail-
Adresse öffnet sich ein E-Mail-Fenster der installierten E-Mail-Software und 
der ausgewählten E-Mail-Adresse im Kontaktfeld. Wird die E-Mail ausgefüllt und
abgeschickt, werden die mit der E-Mail übermittelten personenbezogenen Daten des
Nutzers gespeichert.
...
h3. 6.2 Rechtsgrundlage für die Datenverarbeitung 
...
h2. 7. Werkbezogene, personenbezogene Daten

h3. 7.1 Beschreibung und Umfang der Datenverarbeitung

*46* Auf der Seite "Digitalisierte Drucke" werden Namen und Rollen von Personen
verarbeitet, die von Bibliothekaren als Urheber eines Werks angesehen wurden
(z.B. weil sie im Digitalisat als Urheber bezeichnet werden).

h3. 7.2 Rechtsgrundlage für die Verarbeitung personenbezogenen Daten

*47* Rechtsgrundlage für die Verarbeitung personenbezogener Daten ist Art. 6 
Abs. 1 lit. e DSGVO. 

h3. 7.3 Zweck der Datenverarbeitung

*48* Die Verarbeitung der personenbezogenen Daten dient dazu, Werke unterscheiden
und finden zu können. Die Autoren hatten höchst wahrscheinlich bei der 
Veröffentlichung das Interesse im Zusammenhang mit dem Werk genannt zu werden.
In diesem Zweck liegt auch unser berechtigtes Interesse nach Art. 6 Abs. 1 lit. e DSGVO.

h3. 7.4 Dauer der Speicherung

*49* Da die Daten auch in der Zukunft benötigt werden, um den Zweck der
Anwendungen zu erfüllen, werden die Daten nicht gelöscht.

h3. 7.5 Widerspruchs- und Beseitigungsmöglichkeit

*50* Finden Nutzer Daten, die über sie Aussagen treffen und nicht notwendig sind, 
um den Zweck der Anwendung zu erfüllen bzw. Fehler in diesen Daten, können sie
sich über die E-Mail-Adresse "semweb@hbz-nrw.de(E-Mail Linked Open Data)":mailto:semweb@hbz-nrw.de an die Linked Open Data-Gruppe wenden. Weitere
Wege zur Kontaktaufnahme finden sich unter "http://lobid.org/team(lobid-Teamseite)":http://lobid.org/team.
Die Daten werden vorrangig bearbeitet.

h2. 8. Webanalyse durch matomo

h3. 8.1 Umfang der Verarbeitung personenbezogener Daten

*51* Wir nutzen das Open-Source-Software-Tool matomo zur Analyse des Surfverhaltens 
...
h3. 8.2 Rechtsgrundlage für die Verarbeitung personenbezogener Daten

*52* Rechtsgrundlage für die Verarbeitung der personenbezogenen Daten der Nutzer
ist Art. 6 Abs. 1 lit. f DSGVO.

h3. 8.3 Zweck der Datenverarbeitung

*53* Die Verarbeitung der personenbezogenen Daten der Nutzer ermöglicht uns eine
...
*54* Die nicht anonymisierten Daten werden gelöscht, sobald sie für unsere
...
*55* Die Erfassung der Daten findet automatisch statt. Die nicht anoynmisierten
Daten werden nach 7 Tagen gelöscht, anonymisierte Daten werden nicht gelöscht,
da sie keiner Person mehr zuordbar sind.

h2. 9. Links zu anderen Webseiten

*56* Unser Online-Angebot enthält Links zu anderen Websites. Wir haben keinen
Einfluss darauf, dass deren Betreiber die Datenschutzbestimmungen einhalten.

h2. 10. Datensicherheit

*57* Die verarbeiteten Daten sind innerhalb des hbz-Rechenzentrums gespeichert, zu
welchem nur ein beschränkter Mitarbeiterkreis Zutritt hat. Da es öffentlich
zugängliche Daten sind, werden diese weiterverbreitet.

h2. 11. Aktualität und Änderung dieser Datenschutzerklärung

|Version|Datum|Beschreibung|
|0.1|15.05.2018|Der erste Entwurf.|
|1.0|22.05.2018|Erste offizielle Fassung.|
|1.1|24.05.2018|Abschnitt matomo hinzugefügt.|
